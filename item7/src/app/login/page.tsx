  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
      ...
      <p className="text-gray-600 mb-8 flex items-center">
        Login To Item7 Go <Leaf className="w-5 h-5 text-green-600" />
      </p>
      ...
      >
        ...
        <div
          className="w-full cursor-pointer flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 py-3 rounded-xl text-gray-700 font-medium transition-all duration-200"
